...
CShader::~CShader()
{
	...
	SAFE_RELEASE(m_pFbxNormalStaticMesh_VertexLayout);
	SAFE_RELEASE(m_pFbxNormalStaticMesh_VS);
	SAFE_RELEASE(m_pFbxNormalStaticMesh_PS);
...
HRESULT CShader::InitShaderFbx()
{
	...
	MakeShader(_T("VS"), _T("FbxNormalStaticMesh_VS.cso"), (void**)&m_pFbxNormalStaticMesh_VS, FbxStaticNM_layout, numElements, &m_pFbxNormalStaticMesh_VertexLayout);
	MakeShader(_T("PS"), _T("FbxNormalStaticMesh_PS.cso"), (void**)&m_pFbxNormalStaticMesh_PS);
